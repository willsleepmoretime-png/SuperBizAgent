...
public class VectorEmbeddingService {
    ...
    public List<Float> generateEmbedding(String content) {
        ...
        try {
            ...
            logger.info("PERF embedding.single durationMs={} contentLength={} vectorDim={} model={}",
                    elapsedMs(startNs), content.length(), floatEmbedding.size(), model);
    ...
    public List<List<Float>> generateEmbeddings(List<String> contents) {
        ...
        try {
            ...
            logger.info("PERF embedding.batch durationMs={} count={} vectorDim={} model={}",
                    elapsedMs(startNs),
                    contents.size(),
                    embeddings.isEmpty() ? 0 : embeddings.get(0).size(),
                    model);
